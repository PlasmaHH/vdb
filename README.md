...
## svd file support
For "bare metal" programming we support parsing svd files to get named access to mmapped special registers (mostly ARM
processors)
[You can find detailed information about this module here](doc/SVD.md)
## pipe
